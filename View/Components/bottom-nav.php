...
<nav class="navbar navbar-expand navbar-light fixed-bottom navbar-bottom shadow" style="background-color: #2B3788;">
    <div class="container justify-content-around">
        <a class="nav-link active d-flex flex-column align-items-center" href="<?= BASE_URL ?>/View/pages/homepage/explore.php">
        ...
        <a class="nav-link d-flex flex-column align-items-center" href="<?= BASE_URL ?>/View/pages/homepage/analyze.php">
        ...
        <a class="nav-link d-flex flex-column align-items-center" href="<?= BASE_URL ?>/View/pages/homepage/fishpedia.php">
        ...
        <a class="nav-link d-flex flex-column align-items-center" href="<?= BASE_URL ?>/View/pages/homepage/profile.php">
